...
def convert_file():
    ...
    data_file_dir = DATADIR / 'NOAA v61'

    filename = data_file_dir / 'aravg.ann.land_ocean.90S.90N.v6.1.0.202604.asc'
    ts_filename = data_file_dir / f'{timestamp}_aravg.ann.land_ocean.90S.90N.v6.1.0.202604.asc'
